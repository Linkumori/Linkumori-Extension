...
This security policy was last updated on May 7, 2025.The user is asking me to update the SECURITY.md file to include information about the new announcement regarding the Linkumori extension ID change and retirement of the self-hosted version. 

From the GitHub announcement screenshot shared earlier, I learned:
1. Linkumori is retiring the old self-hosted version extension ID (kcpfnbjimoikcjiifooapdpdmjigd)
2. They're replacing it with a new extension ID (pffeeolamnojgceidanobjnipbjffipb)
3. Users on version 155 or later don't need to take action
4. Users on earlier versions need to uninstall their current version and install the latest from GitHub
5. Enterprise users using Chrome need to update registry policies to whitelist the new extension ID
6. The self-hosted version will continue to exist

I should add this information to the SECURITY.md file, possibly as a new section or as an update to an existing section. The most relevant sections would probably be the "Update Policy" or I could create a new section specific to this announcement.

I'll create an updated version of the SECURITY.md file incorporating this information.

I'll update the SECURITY.md file to include information about the recent extension ID change announcement:
